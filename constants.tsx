...
export const RAW_STOCKS: Record<string, StockConfig> = {
  腾讯: {
    ...
    分红率: (17.05 + (14.96 + 16.01 + 18.79 + 17.05 + 17.12) / 5) / 2, // 16.918
    // 1.94, 27.05, 29.01, 46.57, 28.53
    回购率: (28.53 + (1.94 + 27.05 + 29.01 + 46.57 + 28.53) / 5) / 2, // 27.575
    股权折价: 0.8,
    额外价值: 0
  },
  茅台: {
  ...
  泡泡: {
    ...
    分红率: (25.02 + (25.07 + 25.33 + 35.03 + 35.01 + 25.02) / 5) / 2, // 27.056
    // 38.13, 100, 31.55, 2.09, 0
    回购率: (31.55 + (38.13 + 100 + 31.55 + 2.09 + 0) / 5) / 2,  // 32.952
    股权折价: 0.8,
    额外价值: 0
  },
  汾酒: {
