...
export const RAW_PROPERTIES: Property[] = [
  ...
  { code: 'SH600809', tag: '中港', num: 1300, name: '汾酒', danbao: true },
  { code: 'SH600519', tag: '中港', num: 500, name: '茅台', danbao: true },
  { code: 'SZ000568', tag: '中港', num: 6000, name: '老窖', danbao: true },
